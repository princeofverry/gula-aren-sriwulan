...
const ApaItuGula = () => {
    return (
        <div className='pad-x my-8 space-y-4'>
            <div>
                ...
                <div className='flex flex-col md:flex-row items-center justify-center gap-6 pb-4'>
                    ...
                    <p className='text-lg md:text-xl tracking-widest text-justify'>Gula aren, si pemanis alami berwarna cokelat keemasan, berasal dari nira pohon aren (Arenga pinnata). Bahan bakunya diperoleh melalui proses tradisional, yaitu dengan menyadap mayang bunga jantan pohon tersebut. Hasilnya adalah pemanis dengan rasa karamel yang khas, yang telah lama menjadi jiwa dalam berbagai hidangan dan minuman tradisional Nusantara.</p>
                </div>
            </div>
            <div>
